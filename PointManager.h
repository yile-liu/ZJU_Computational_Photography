...
public:
    ...
    void init(const vector<vector<Point>> &structure_lines, const Mat1b &mask, int block_size,
    ...
    void getStackReverseIter(list<shared_ptr<MyNode>>::reverse_iterator &begin,
...
private:
    ...
    int addNeighbor(MyNode &n, const PointPos &pos, vector<vector<ushort>> &visited_points,
